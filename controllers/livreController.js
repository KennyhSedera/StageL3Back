...
exports.findOne = (req, res) => {
  livre
    .findOne({ where: { id_livre: req.params.id } })
    .then((result) => {
...
exports.update = (req, res) => {
  livre
    .update(req.body, { where: { id_livre: req.params.id } })
    .then((result) => {
...
exports.delete = (req, res) => {
  livre
    .destroy({ where: { id_livre: req.params.id } })
    .then((result) => {
...
exports.count = (req, res) => {
  livre
    .findAll({
      attributes: [
        "emplacement_livre",
        [Sequelize.fn("Count", Sequelize.col("id_livre")), "Total"],
      ],
...
exports.countEmprunt = (req, res) => {
  livre
    .count({ where: { status_livre: "Emprunter" } })
    .then((result) => {
      res.send({ total: result });
    })
    .catch((err) => {
...
exports.getAllLivreDispo = (req, res) => {
  livre
    .findAll({ where: { status_livre: "Dispo" } })
    .then((result) => {
      res.send({ livres: result });
    })
    .catch((err) => {
